namespace Constants
{
    public static class Stage
    {
        ...
        public static readonly float FirstLineYPos = 14.5f;
        ...
        public static readonly float DeadLineOfYPos = 2.5f;

        // （UFO）座標系
        public static readonly float UFOYPos = FirstLineYPos + 1.5f;
